...
export const careerHistory: CareerEntry[] = [
  {
    ...
    role: "ITコンサルタント",
    summary:
      "官公庁・金融・製造・サステナビリティ等、多様な業界でIT/DX支援に従事。AI/データ分析、IT・Cyber DD、PMOなど領域は幅広い。",
    projects: [
      {
        name: "官公庁向け業務標準化・制度DX支援",
        description:
          "自治体事務のデジタル化に向けた業務標準化・制度DXの推進（現在進行中）",
        highlights: [
          "業務の標準的なあり方の整理・提示",
          "システム化に向けた要件定義",
          "費用対効果試算",
      ...
      },
      {
        ...
        description:
          "Anaplan環境の修正対応における要件定義からカットオーバーまでの管理",
        highlights: [
          "要件検討・整理の推進、クライアント窓口",
          "Anaplan環境の実装およびテスト準備・実施の管理",
        ],
      },
      {
        name: "生成AI活用PoC支援",
  ...
  },
  {
    ...
    role: "システムエンジニア",
    summary:
      "金融機関向け基幹システム（海外送金・カード）の新規開発・保守開発に従事。設計・実装・テストからチームマネジメント、性能改善まで幅広く経験。",
    projects: [
      {
        name: "海外送金基幹システム新規開発",
        description:
          "海外拠点向け送金基幹システムの新規開発。送金機能チームおよび非機能・技術統括チームを担当",
        highlights: [
          "送金機能チームのサブリーダーとして設計書・ソースコードレビュー、テスト推進",
          "非機能・技術統括チームリーダーとして性能調査・改善",
          "フレームワーク標準化、フレームワークガイド作成・各チームへの展開",
        ],
      },
      {
        name: "カード基幹システム保守開発",
